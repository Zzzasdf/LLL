...
public class SubViewCollectMultipleContainer<TSubViewCollectLocator, TSubViewLocator, TViewLoader> : ISubViewCollectContainer
    ...
    where TViewLoader: IViewLoader
{
    ...
    public SubViewCollectMultipleContainer(int poolCapacity, int preDestroyCapacity = 10, int preDestroyMillisecondsDelay = 10)
    {
